...
WHERE       GEAR_CODE like 'L' and YY>1989 and YY<=2022
"
...
plot(eff.props$prop.HS_fad~eff.props$YY, ylim=c(0.00,0.5), type="l", col="black", lwd=2, xlab="Year", ylab="Proportion of PS effort in HS"); 
...
save(all.ind, file="all_effort_indicators_2023.Rdata")
