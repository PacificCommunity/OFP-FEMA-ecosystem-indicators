#########################################################################
# Target Species Catch and Distribution indicators - for SC18 paper 2022
#########################################################################
...
# 1) Decision was made to only report Annual Tuna Catch for the 2022 SC paper.
# 2) Addition of new data from 1990 to 2021 inclusive.
...
# Set dir.
setwd('P:/OFPEMA/WCPFC/SC18/Ecosystem Indicators/Catch and distribution')
...
# Full aggregated catch data (from Steven Hare's extract @ 27/06/22)
catch_dat<-read.csv("agg.data.jed.2022.csv")
...
for (i in unique(sp.stk)){
  setwd(paste("P:/OFPEMA/WCPFC/SC18/Ecosystem indicators/Catch and distribution/",i, sep=""))
...
for (i in unique(species)){
  ...
  dir<-paste("P:/OFPEMA/WCPFC/SC18/Ecosystem Indicators/Catch and distribution/", i, sep="")
  setwd(dir)
...
# Annual Tuna Catch
dir<-"P:/OFPEMA/WCPFC/SC18/Ecosystem Indicators/Catch and distribution/"
setwd(dir)
